...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Create an instace to store game statistics and a scoreboard
    ...
    def _create_fleet(self):
        ...
        while current_y < (self.settings.screen_height - 3 * alien_height):
            ...
            # Finished a rwo; reset x value, and increment y value.
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            ...
            # Get rid of any remaining bullets and alients.
            self.bullets.empty()
            self.aliens.empty()
